...
'Points (Vertices)
Public Type dVertex
    x As Long 'double 'Long
    y As Long 'double 'Long
    z As Long 'double 'Long
End Type
...
'Private Function InCircle(xp As double, yp As double, x1 As double, y1 As double, x2 As double, y2 As double, x3 As double, y3 As double, ByRef xc, ByRef yc, ByRef r) As Boolean
...
frmMAIN.Caption = "pure Delunay computation "
DoEvents
